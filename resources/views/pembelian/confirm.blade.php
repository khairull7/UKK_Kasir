...
<div class="container mt-4">
    <h3 class="mb-4 text-primary">Konfirmasi Penjualan</h3>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        ...
                        <span class="fw-bold text-success">{{ number_format($points_earned, 0, ',', '.') }} Poin</span>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label class="form-label fw-medium">Status Member <span class="text-muted small">Dapat juga membuat member</span></label>
