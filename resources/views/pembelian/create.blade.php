...
@section('content')
                            ...
                            <div class="card h-100 d-flex align-items-center ">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <div class="d-flex align-items-center justify-content-center mb-3">
                                        <button type="button" class="btn btn-outline-primary minus-btn rounded-circle">-</button>
                                        <input type="number" 
                                               ...
                                               style="width: 60px;" 
                                               readonly>
                                        <button type="button" class="btn btn-outline-primary plus-btn rounded-circle">+</button>
                                    </div>
                                    <p class="text-muted">
    ...
    <div class="fixed-bottom p-3 d-flex justify-content-end" style="margin-left: 250px; border-top: none;">
        <button type="button" id="submitBtn" class="btn btn-primary" style="width: 200px;">
            Selanjutnya
        </button>
    </div>
