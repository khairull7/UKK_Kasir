...
// private function prepareSelectedProducts(Request $request)
// {
//     $items = $request->items;
//     $products = [];
...
//     return $products;
// }
// public function paymentNonMember(Request $request)
// {
//     $totalPrice = $request->total_amount;
//     $totalPay = $request->payment_amount;
//     $totalReturn = $totalPay - $totalPrice;

//     return view('sales.payment-non-member', [
//         'selectedProducts' => $this->prepareSelectedProducts($request),
//         'total' => $totalPrice,
//         'totalPay' => $totalPay,
//         'totalReturn' => $totalReturn,
